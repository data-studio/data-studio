  ...
  <?php if (have_posts()): while (have_posts()) : the_post(); ?>
    ...
    (function ($) {"use strict";
      $.dsTabGroup({
        tabs: [
          {
            $toggleEl: $( '#ModelNavigation li.tab-design' ),
            $contentEl: $( '#ModelTabbedContent div.tab-design' ),
          },
          {
            $toggleEl: $( '#ModelNavigation li.tab-discuss' ),
            $contentEl: $( '#ModelTabbedContent div.tab-discuss' ),
          },
          {
            $toggleEl: $( '#ModelNavigation li.tab-configure' ),
            $contentEl: $( '#ModelTabbedContent div.tab-configure' ),
          },
          {
            $toggleEl: $( '#ModelNavigation li.tab-build' ),
            $contentEl: $( '#ModelTabbedContent div.tab-build' ),
          },
        ],
      })
    })(jQuery);
